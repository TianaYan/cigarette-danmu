...
(function () {
  ...
  // 10 条弹幕轨道 (top 百分比), 上下错开, 避免互相重叠
  // 顶部 5 条: 0.06 / 0.14 / 0.22 / 0.30 / 0.38
  // 底部 5 条: 0.62 / 0.70 / 0.78 / 0.86 / 0.94
  // 留出 0.40-0.60 范围 (烟的中部) 不放弹幕
  const trackRows = [0.06, 0.14, 0.22, 0.30, 0.38, 0.62, 0.70, 0.78, 0.86, 0.94];
  let lastTrackIdx = -1;
